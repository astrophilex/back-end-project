...
<html>
	<head>
		...
		<script src="js/seoulweather.js"></script>
		...
		<link rel="stylesheet" type="text/css" href="css/showslide.css">
			...
			<section>			
				<article id = "infoviewBoxFV">
					<div id = "infobackgroundFV">
						<img src = "image/서울.jpg" class = "infobg">
					</div>	
					<span class = "text">I●SEOUL●YOU</span>
				...
				<div class="weather">
				   <div class="CurrIcon2">${CurrIcon2}</div>
					 <div class="CurrTemp2">${CurrTemp2}</div>
				   <div class="City2">${City2}</div>
				   <div class="hum">습도:${hum}</div>
				   <div class="wind">풍속:${wind}</div>
				</div>		
